...
kbl_wp_chart_new(data=pbp_test, training_data=pbp2, "SVM", show_labels = T)
```
...
The predictions of three algorithms—Logistic Regression, Naive Bayes, and Neural Network—predicted similar patterns. However, Random Forest demonstrated a relatively higher variability compared to the other three. Due to this increased variability, the GEI of the Random Forest model was the highest among the four models.
