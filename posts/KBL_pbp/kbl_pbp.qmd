...
$T$ in the formula denotes the time remaining in the game with 2400 being the total duration. $n$ represents the number of plays executed, and $p_i$ is the winning probability of home team on $i$th play of the game.
