...
Overall, we found evidence that Hot Hand may be an illusion based on the data. It turned out that the distance and location were statistically significant for both predicting and inference perspectives. Thus, if a player on the court seems to be having a Hot Hand, this might be due to the distance and not the streak of success. Therefore, it may not be an ideal strategy for a coach to solely rely on a "hot-hand" player to take the final shot when the game is tied in the closing seconds.
